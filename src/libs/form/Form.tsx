...
const Form = () => {
  ...
  return (
    <>
      ...
      <dialog
        ref={endDialogRef}
        className="fixed top-1/2 left-1/2 h-fit w-fit wrap-none max-h-[30vh] w-[90vw] -translate-x-1/2 -translate-y-1/2 rounded-xl bg-white shadow-xl dark:bg-gray-800"
      >
        ...
        <form onSubmit={restart} className="p-6 text-center">
          <h1 className="text-3xl">Thank you for your participation,{" "}
            <span className="font-bold">{nameInputRef.current?.value}</span>.</h1>
          ...
          <p className="text-xl m-4">
            You have passed{" "}
            <span className="font-bold italic">"The Test"</span>.
          </p>
          <p className="text-xl m-4">
            Agents will soon be on their way.
          </p>
          <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="submit">Go again?</button>
        </form>
      </dialog>
    </>
  );
